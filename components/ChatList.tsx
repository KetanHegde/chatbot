...
function ChatListComponent({ currentChatId }: ChatListProps) {
  ...
  return (
    <div className="w-80 bg-gradient-to-br from-gray-900 to-black border-r border-gray-800 flex flex-col">
